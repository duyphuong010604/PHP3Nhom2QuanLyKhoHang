                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            ...
                                            data-dropdown-parent="#kt_menu_61484c4e0b17a" data-allow-clear="true">
                                            <option></option>
            ...
            <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex overflow-auto h-55px">
                            <ul
                                ...
                                <!--begin::Nav item-->
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary me-6 active" href="{{ route('tai-khoan.show', 3) }}">Thông tin</a>
                                </li>
                                <!--end::Nav item-->
                                <!--begin::Nav item-->
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary me-6" href="{{ route('tai-khoan.edit', 3) }}">Cài đặt</a>
                                </li>
                                <!--end::Nav item-->
                            </ul>
                        </div>
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-header cursor-pointer">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <a href="{{ route('tai-khoan.edit', 3) }}" class="btn btn-primary align-self-center">Sửa thông tin</a>
                        <!--end::Action-->
                    </div>
                    <!--begin::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $profiles->fullname }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <a href="#"
                                    class="fw-bold fs-6 text-gray-800 text-hover-primary">{{ $profiles->email }}</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <a href="#"
                                    class="fw-bold fs-6 text-gray-800 text-hover-primary">{{ $profiles->address }}</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
