                                ...
                                <form id="kt_invoice_form">
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
                                            <span class="fs-2x fw-bolder text-gray-800">Đợt xuất #{{ $OutboundShipment->id }}</span>
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <!--end::Input group-->
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-5">
                                                    <select class="form-select form-control form-control-solid fw-bolder" readonly>
                                                        <option value="{{ $OutboundShipment->customer->customer_id}}">{{ $OutboundShipment->customer->phone }}</option>
                                                    </select>
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" placeholder="Email" value="{{ $OutboundShipment->customer->email }}" readonly>
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-5">
                                                    <select class="form-select form-control form-control-solid fw-bolder" readonly>
                                                        <option value="{{ $OutboundShipment->shelf->id }}">{{ $OutboundShipment->shelf->name }}</option>
                                                    </select>
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <textarea name="notes" class="form-control form-control-solid" rows="1" placeholder="Ghi chú?" readonly>{{ $OutboundShipment->remarks }}</textarea>
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            <!--end::Col-->
                                        ...
                                        <div class="table-responsive mb-10">
                                            ...
                                            <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700" data-kt-element="items">
                                                ...
                                                <tbody class="fw-bold text-gray-600">
                                                    @foreach($OutboundShipmentDetails as $detail)
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="align-top fw-bolder text-gray-700">
                                                        ...
                                                        <th><input type="text" value="{{ $OutboundShipment->totalAmount }}" readonly class="form-control form-control-solid text-end"></th>
                                                    </tr>
                                                </tfoot>
                                                <!--end::Table foot-->
                                            </table>
