                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            <li class="breadcrumb-item text-muted">
                                <a href="../../demo1/dist/index.html" class="text-muted text-hover-primary">Trang
                                    chủ</a>
                            </li>
                            ...
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Tìm kiếm khách hàng" wire:model.live="q" />
                                </div>
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    ...
                                                    wire:click="applyFilter">Áp dụng</button>
                                            </div>
                                            <!--end::Actions-->
                                        </div>
                                        <!--begin::Content-->
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    @foreach($this->customers as $customer)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-gray-600 text-hover-primary mb-1">{{ $customer->email }}</a>
                                            </td>
