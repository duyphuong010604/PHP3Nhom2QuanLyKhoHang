                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        {{-- <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Tìm kiếm đơn hàng" search />
                        </div> --}}
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Tên nhà cung cấp</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach($paginator as $InboundShipment)
                            <tr>
                                <!-- Checkbox -->
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="{{ $InboundShipment->id }}" />
                                    </div>
                                </td>
                                <!-- ID -->
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $InboundShipment->id }}</a>
                                </td>
                                <!-- Name -->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $InboundShipment->supplier->name }}</a>
                                </td>
                                <!-- Created At -->
                                <td>{{ $InboundShipment->created_at }}</td>
                                <!-- Updated At -->
                                <td>{{ $InboundShipment->updated_at }}</td>
                                <!-- Status -->
                                <td>
                                    <span class="badge badge-success">{{ $InboundShipment->status }}</span>
                                </td>
                                <!-- Action -->
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a href="{{ route('nhap-hang.detail', $InboundShipment->id) }}" class="menu-link px-3">Xem chi tiết</a>
