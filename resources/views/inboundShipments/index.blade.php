                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a href="../../demo1/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">20231</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">Nhà cung cấp 1</a>
                            </td>
                            <!--end::Email=-->
                            <!--begin::Company=-->
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('nhap-hang.show', ['id' => 1]) }}" class="menu-link px-3">Xem chi tiết</a>

                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="{{ route('nhap-hang.edit', ['id' => 1]) }}" class="menu-link px-3">Chỉnh sửa</a>
