						...
						<div class="w-lg-600px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
								...
								<div class="mb-10 text-center">
									...
									<a href="../../demo1/dist/authentication/flows/aside/sign-in.html" class="link-primary fw-bolder">Đăng nhập tại đây</a></div>
									<!--end::Link-->
								</div>
								<!--end::Heading-->
								<!--begin::Action-->
								<button type="button" class="btn btn-light-primary fw-bolder w-100 mb-10">
								<img alt="Logo" src="assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Đăng nhập với Google</button>
								<!--end::Action-->
								<!--begin::Separator-->
