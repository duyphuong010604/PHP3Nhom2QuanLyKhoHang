        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Sửa hàng tồn kho
                    </h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                                    ...
                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" value="Iphone 15 ProMax"
                                                    name="Tên sản phẩm" />
                                                <!--end::Input-->
                                            </div>
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <select name="country" data-control="select2"
                                                    data-dropdown-parent="" data-placeholder="Chọn loại sản phẩm..."
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Select-->
                                                <select name="zone" data-control="select2"
                                                    data-dropdown-parent="" data-placeholder="Chọn phân khu..."
                                                    class="form-select form-select-solid">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--begin::Select-->
                                                <select name="zone" data-control="select2"
                                                    data-dropdown-parent="" data-placeholder="Chọn trạng thái..."
                                                    class="form-select form-select-solid">
                                        ...
                                        <div class="d-flex flex-column mb-5 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="" name="Số lượng" value="100"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->                                  
