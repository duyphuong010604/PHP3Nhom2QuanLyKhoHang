                    ...
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body pt-15">
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">Thanh nhàn</a>
                                <div class="fs-5 fw-bold text-muted mb-6">Quản lý</div>
                            ...
                            <div id="kt_customer_view_details" class="collapse show">
                                <div class="py-5 fs-6">
                                    <div class="fw-bolder mt-5">Tài khoản ID</div>
                                    <div class="text-gray-600">ID-45453423</div>
                                    <div class="fw-bolder mt-5"> Email</div>
                                    <div class="text-gray-600">
                                        <a href="#" class="text-gray-600 text-hover-primary">Nhan@gmail.com</a>
                                    </div>

                                    <div class="fw-bolder mt-5">Địa chỉ</div>
                                    <div class="text-gray-600">Trần Văn Hoài,
                                        <br />Cần thơ
                                        <br />Việt nam
                                    </div>

                                    <div class="fw-bolder mt-5">Ngôn ngữ</div>
